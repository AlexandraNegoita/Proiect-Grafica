...
public:
	...
	Matrix(GLfloat val);
	Matrix(Matrix & mat);
	Matrix(GLfloat xx, GLfloat xy, GLfloat xz, GLint val1, GLfloat yx, GLfloat yy, GLfloat yz, GLint val2, GLfloat zx, GLfloat zy, GLfloat zz, GLint val3, GLint val4, GLint val5, GLint val6, GLint val7);
