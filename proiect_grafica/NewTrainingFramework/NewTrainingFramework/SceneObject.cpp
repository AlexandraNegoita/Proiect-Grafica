...
void SceneObject::Load() {
	model = new Model(*(ResourceManager::getInstance() -> loadModel(SceneObject::modelId)));
	shader = new Shader(*(ResourceManager::getInstance() -> loadShader(SceneObject::shaderId)));
