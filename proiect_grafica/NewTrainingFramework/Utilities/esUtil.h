...
public:
   ...
   void (ESCALLBACK* mouseFunc) (ESContext*, int, bool, bool, float, float); //left/right button, click/dublu-click, isPressed, coordX, coordY
...
//todo: mouse btype :int, event type(enum mouseEvent: click, doubleClick), x,y - coordonate

void ESUTIL_API esRegisterMouseFunc(ESContext* esContext,
    void (ESCALLBACK* drawFunc) (ESContext*, int, bool, bool, float, float));
