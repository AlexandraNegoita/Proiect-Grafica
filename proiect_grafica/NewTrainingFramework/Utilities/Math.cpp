...
Matrix::Matrix(GLfloat xx, GLfloat xy, GLfloat xz, GLint val1, GLfloat yx, GLfloat yy, GLfloat yz, GLint val2, GLfloat zx, GLfloat zy, GLfloat zz, GLint val3, GLint val4, GLint val5, GLint val6, GLint val7)
{
	m[0][0] = xx; m[0][1] = xy; m[0][2] = xz; m[0][3] = val1;
	m[1][0] = yx; m[1][1] = yy; m[1][2] = yz; m[1][3] = val2;
	m[2][0] = zx; m[2][1] = zy; m[2][2] = zz; m[2][3] = val3;
	m[3][0] = val4; m[3][1] = val5; m[3][2] = val6; m[3][3] = val7;
}
...
Matrix Matrix::operator * (GLint k)
{
	Matrix mat(*this);
	mat *= k;
	return mat;
